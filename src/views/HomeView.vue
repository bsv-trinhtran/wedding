<template>
  ...
  <div class="main">
      ...
      >
        <swiper-slide>
          <div
            class="background"
            style="
              background: url(/images/NPT07732.jpg) no-repeat center;
        ...
        <swiper-slide>
          <div
            class="background"
            style="
              background: url(/images/NPT07955.jpg) no-repeat center;
              background-size: cover;
            "
          ></div>
        </swiper-slide>
              ...
              <div class="event-title">
                <div style="display: flex; gap: 20px">
                  <div style="display: flex; align-items: center; gap: 6px">
                    <img src="/images/icons8-date-80.png" alt="" />
                    <span>2023-10-12</span>
                  </div>
                  <div style="display: flex; align-items: center; gap: 6px">
                    <img src="/images/icons8-clock-48.png" alt="" />
                    <span> 11:00</span>
                  </div>
                </div>
                <div>
                  <img src="/images/icons8-location-50.png" alt="" />
                  <span>5B Nguyễn Công Trứ - KP5, Lagi - Bình Thuận</span>
                </div>
                <div>
                  <a
                    href="https://goo.gl/maps/UuREuBNqi644JB2D8"
                    style="text-decoration: none; color: #397eb9"
                  >
                    Xem bản đồ
                  </a>
                  <img
      ...
      <div class="container">
        <div class="invitation-box">
          <div class="inner">
            ...
            <a @click="scrollToSection('wishes')" class="theme-btn" id="scroll"
              >Gửi lời chúc</a
            >
          </div>
        </div>
    ...
    <div class="gallery" id="gallery">
      <div class="container">
        ...
        <div class="grid">
          ...
          <div
            class="grid-item"
            style="position: absolute; left: 66.6667%; top: 293.594px"
          >
          ...
          <div
            class="grid-item"
            style="position: absolute; left: 66.6667%; top: 853.594px"
          >
          ...
          <div
            class="grid-item"
            style="position: absolute; left: 66.6667%; top: 1414.31px"
          >
            <img src="/images/NPT07878.jpg" alt="" />
          </div>
          <div
            class="grid-item"
            style="position: absolute; left: 33.3333%; top: 1380.31px"
          >
    ...
    <div class="bii-player" @click="playAudio">
      ...
      <audio id="myAudio">
        <source src="/images/Perfect-EdSheeran-6445593.mp3" type="audio/mpeg" />
      </audio>
    </div>
    <!-- <Heart></Heart> -->
    <Modal
...
const countdownInterval = setInterval(function () {
  ...
  if (distance <= 0) {
    ...
    days.value = addLeadingZero(Math.floor(distance / (1000 * 60 * 60 * 24)));
    ...
    seconds.value = addLeadingZero(Math.floor((distance % (1000 * 60)) / 1000));
  }
}, 1000);
